...
class _ListviewBuilderScreenState extends State<ListviewBuilderScreen> {
  ...
  Future fetchData() async {
    ...
    //despues de actualziar los sigueintes 5 mueve la pantalla un poco hacia abajo
...
//metodo para añadir 5 unidades mas a la lsita mientras te acercas al final del scroll
  void add5() {
